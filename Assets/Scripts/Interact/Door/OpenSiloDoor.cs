...
public class OpenSiloDoor : MonoBehaviour
{
    ...
    void OpenDoor_input()
    {   
        //if(CanBeOpen && Input.GetKeyDown(KeyCode.E) && checkGenerator[0].IsOn && checkGenerator[1].IsOn && checkGenerator[2].IsOn)
        if(CanBeOpen && Input.touchCount > 0 && checkGenerator[0].IsOn && checkGenerator[1].IsOn && checkGenerator[2].IsOn) 
        {
